...
```yaml
# config/colm/train_probing_qwen25_coder_7b.yaml
mode: train_probing
benchmark: CUE-Bench
...
```bash
python -m brewing --config config/colm/train_probing_qwen25_coder_7b.yaml
```
...
```bash
python -m brewing --config config/colm/qwen25_coder_7b.yaml
```
